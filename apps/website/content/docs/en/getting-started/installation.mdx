...
`coaction/local` gives bundlers a hard boundary that excludes the JSON protocol, epoch,
...
The root `coaction` entry is a compatibility entry. It retains both local and shared mode
