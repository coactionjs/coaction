...
- Added real-browser SharedWorker and Web Worker coverage for the Solid binding,
  validating cross-page signal synchronization, async client actions, and safe
